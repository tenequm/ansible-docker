...
This role applies Docker with daemon configurations and  docker-compose installation (it can also deletes previous version if it is installed) for Debian Jessie.
